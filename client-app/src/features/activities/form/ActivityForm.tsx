...
export default observer(function ActivityForm() {
    ...
    return (
        <Segment clearing>
            <Header content='Aktivite Detayları' sub color='teal' />
            <Formik
                ...
                {({ handleSubmit, isValid, isSubmitting, dirty }) => (
                    <Form className='ui form' onSubmit={handleSubmit} autoComplete='off'>
                        ...
                        />
                        <Header content='Yer Detayları' sub color='teal' />
                        <MyTextInput placeholder='Şehir' name='city' />
                        <MyTextInput placeholder='Mekan' name='venue' />
                        <Button
                            disabled={isSubmitting || !dirty || !isValid}
                            loading={isSubmitting} floated='right'
                            positive type='submit' content='Onayla' />
                        <Button as={Link} to='/activities' floated='right' type='button' content='Iptal' />
                    </Form>
                )}
            </Formik>
